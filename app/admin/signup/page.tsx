...
function AdminSignUpInner() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(160deg,#0A0E15,#0F1B26)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Space Grotesk', sans-serif", padding: '40px 0', boxSizing: 'border-box' }}>
      <div style={{ width: '100%', maxWidth: 460, padding: '0 24px' }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          <div style={{ fontSize: 36, marginBottom: 12 }}>✦</div>
          <div style={{ fontSize: 11, letterSpacing: '.4em', textTransform: 'uppercase' }}>
            <span style={{ color: '#E8EDF2' }}>Cuv</span><span style={{ color: '#3FC6D4' }}>Ai</span>
          </div>
          <div style={{ color: '#E8EDF2', fontSize: 22, fontWeight: 700, marginTop: 4 }}>Create Your Account</div>
          <div style={{ color: '#8A95A5', fontSize: 13, marginTop: 6 }}>Start your 14-day free trial</div>
          {initialEmail && (
        ...
        <div style={{ background: 'rgba(255,255,255,.03)', border: '1px solid rgba(63,198,212,.15)', borderRadius: 16, padding: '28px 24px' }}>
          {hasClerkEnv ? (
            // routing="hash" renders the sign-up steps in-place via the URL hash.
            // This avoids the path-routing redirect-to-sign-in that occurs when the
            // Clerk instance's sign-up URL is the hosted Account Portal.
            <SignUp
              routing="hash"
